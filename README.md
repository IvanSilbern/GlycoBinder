...
1. *RawTools* is extracts quantitative information (reporter ion intensities) from Thermo *.raw* files and assigns MS3 scan to corresponding MS2 scans.
